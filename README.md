...
You can choose to both install the program into the system or download the portable version and use it immediately.

## Future Updates

One future update is already programmed and it consists of adding more output formats, such as `WAV`, `TIFF`, etc...
